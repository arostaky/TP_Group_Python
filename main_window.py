...
cmds.window(winName, width=winWidth, title='Forniture Generator', bgc=(40.0/255.0,35.0/255.0,39.0/255.0))
...
cmds.iconTextButton(style='iconAndTextVertical', image1='/home/fullarostaky/maya/2020/scripts/icons/2x/canape.png', label='Canape',width=mainRLWidth[1]*0.2, c='table()')
...
cmds.window(winName, e=True, width=winWidth, height=460)