...
cmds.iconTextButton(style='iconAndTextVertical', image1='/home/fullarostaky/maya/2020/scripts/icons/2x/chaise.png', label='Chaise',width=mainRLWidth[1]*0.2, c='table()')
